...
namespace Cnblogs.DashScope.Core
{
    ...
    /// <param name="toolCallId">Used when role is tool, represents the function name of this message generated by.</param>
    ...
    /// <returns></returns>
    public static TextChatMessage User(string content)
    {
        return new TextChatMessage(DashScopeRoleNames.User, content);
    }
