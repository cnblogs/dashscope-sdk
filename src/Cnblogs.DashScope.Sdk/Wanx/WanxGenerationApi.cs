...
public static class WanxGenerationApi
{
    ...
    [Obsolete("Use CreateImageSynthesisTaskAsync instead.")]
    ...
    [Obsolete("Use GetImageSynthesisTaskAsync instead.")]
    ...
    [Obsolete("Use CreateImageGenerationTaskAsync instead.")]
    ...
    /// <param name="cancellationToken">The cancellation token to use.</param>
    /// <returns></returns>
    [Obsolete("Use GetImageGenerationTaskAsync instead.")]
    ...
    /// <param name="cancellationToken">The cancellation token to use.</param>
    /// <returns></returns>
    [Obsolete("Use CreateBackgroundGenerationTaskAsync instead.")]
    ...
    /// <param name="cancellationToken">The cancellation token to use.</param>
    /// <returns></returns>
    [Obsolete("Use GetBackgroundGenerationTaskAsync instead.")]
