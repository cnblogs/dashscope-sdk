            ...
            new(
                ...
                new ApplicationResponse(
                    ...
                    new ApplicationUsage(
                        new List<ApplicationModelUsage> { new ApplicationModelUsage("qwen-plus", 2591, 290) })));
        ...
        public static readonly RequestSnapshot<ApplicationRequest, ApplicationResponse> SinglePromptSse =
            new(
                ...
                new ApplicationResponse(
                    ...
                    new ApplicationUsage(
                        new List<ApplicationModelUsage> { new ApplicationModelUsage("qwen-max-latest", 2304, 244) })));
            ...
            new(
                ...
                new ApplicationResponse(
                    ...
                    new ApplicationOutput(
                        ...
                        null),
                    new ApplicationUsage(
                        new List<ApplicationModelUsage> { new ApplicationModelUsage("deepseek-r1", 1129, 1126) })));
            ...
            new(
                ...
                new ApplicationResponse(
                    ...
                    new ApplicationOutput(
                        ...
                        null),
                    new ApplicationUsage(
                        new List<ApplicationModelUsage> { new ApplicationModelUsage("qwen-plus", 1201, 43) })));
            ...
            new(
                ...
                new ApplicationResponse(
                    ...
                    new ApplicationOutput(
                        ...
                        null),
                    new ApplicationUsage(
                        new List<ApplicationModelUsage> { new ApplicationModelUsage("deepseek-r1", 1283, 1081) })));
            ...
            new(
                ...
                new ApplicationResponse(
                    ...
                    new ApplicationOutput(
                        ...
                        null),
                    new ApplicationUsage(
                        new List<ApplicationModelUsage> { new ApplicationModelUsage("qwen-plus", 344, 311) })));
    }
}
