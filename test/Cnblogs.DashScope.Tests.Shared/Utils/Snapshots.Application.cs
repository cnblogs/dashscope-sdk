                ...
                new(
                    ...
                    new ApplicationRequest
                    {
                        ...
                        Parameters = new ApplicationParameters
                        {
                            ...
                            {
                                PipelineIds = new List<string> { "thie5bysoj" },
                                FileIds = new List<string> { "file_d129d632800c45aa9e7421b30561f447_10207234" }
                            }
                        }
                    },
                ...
                new(
                    ...
                    new ApplicationRequest
                    {
                        ...
                        Parameters = new ApplicationParameters
                        {
                            ...
                            {
                                PipelineIds =
                                    new List<string> { "thie5bysoj" }, Tags =
                                    new List<string> { "xUnit" }
                            }
                        }
                    },
                    new ApplicationResponse(
                ...
                new(
                    ...
                    new ApplicationRequest
                    {
                        ...
                        Parameters = new ApplicationParameters
                        {
                            ...
                            RagOptions = new ApplicationRagOptions
                            {
                                PipelineIds = new List<string> { "ll6yfcnxjg" },
                ...
                new(
                    ...
                    new ApplicationRequest
                    {
                        ...
                        Parameters = new ApplicationParameters
                        {
                            ...
                            RagOptions = new ApplicationRagOptions
                            {
                                PipelineIds = new List<string> { "e6md69132k" },
